...
from src.views import (card_expenses, date_now, exchange_rate, filter_by_date, get_price_stock, get_user_settings,
                       greeting_by_time_of_day, reading_excel_file, transaction_rating_by_amount)
...
xxx = main("2021-10-20", stocks, currency)
print(xxx)
